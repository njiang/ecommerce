(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "pg-"; // Prefix string to be prepended to the cart's name in the session storage
			...
			this.currency = "USD"; // HTML entity of the currency to be displayed in the layout
